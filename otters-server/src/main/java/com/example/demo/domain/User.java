...
//    分割线
    ...
    public String getUserAvatorPic() {
        return userAvatorPic;
    }

    public void setUserAvatorPic(String userAvatorPic) {
        this.userAvatorPic = userAvatorPic == null ? null : userAvatorPic.trim();
    }
